          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl stagger-animate">
              ...
              <p className="text-white/80 text-lg md:text-xl mb-8 max-w-2xl">
                HALO Architects combines innovation, sustainability, and
                timeless design to create extraordinary spaces for living and
                working.
              </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                <div>
                  ...
                  <p className="text-foreground/70 mb-8">
                    Our collaborative approach involves understanding your
                    vision, analyzing the site and context, and delivering
                    innovative solutions that exceed expectations while adhering
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-2xl mx-auto text-center mb-16">
                ...
                <p className="text-foreground/70">
                  ...
                  to say about their experience working with HALO Architects.
                </p>
              </div>
