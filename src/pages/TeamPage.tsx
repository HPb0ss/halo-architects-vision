            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-foreground/70 mb-6">
                  ...
                  collaborative approach ensures that every project reflects the
                  unique vision and needs of our clients.
                </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center mb-16">
              ...
              <p className="text-foreground/70">
                ...
                perspectives to create extraordinary architectural experiences.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-foreground/70 text-lg mb-8 max-w-2xl mx-auto">
                ...
                share our passion for innovative, sustainable design. If you're
                interested in joining HALO Architects, we'd love to hear from
                you.
              </p>
              <a
