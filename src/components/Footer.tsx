      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            <h3 className="font-display text-xl font-medium">HALO ARCHITECTS</h3>
            <p className="text-foreground/70 max-w-xs">
              Creating sustainable, modern, and luxurious spaces that inspire and endure.
            </p>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <Link to="/portfolio" className="text-foreground/70 hover:text-foreground transition-colors">Portfolio</Link>
              <Link to="/team" className="text-foreground/70 hover:text-foreground transition-colors">Our Team</Link>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              <a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Residential Design</a>
              <a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Commercial Projects</a>
              <a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Interior Design</a>
              <a href="#" className="text-foreground/70 hover:text-foreground transition-colors">3D Visualization</a>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-foreground/70">123 Design Avenue, Architecture City, AC 12345</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-foreground/70">info@haloarchitects.com</span>
              </div>
            </div>
          </div>
        </div>
